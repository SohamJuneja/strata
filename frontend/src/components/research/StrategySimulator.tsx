...
const PERIODS: PeriodData[] = [
  ...
  {
    id: "D",
    label: "Q4 2023 -- Pre-ETF uptrend",
    description: "BTC +51% in 12 weeks. Calm uptrend, one brief dip. Hedge drag hurts with only one trigger.",
    finalPH: -0.30,
    finalPLP: 1.26,
    weeks: [
      { week: 1,  date: "2023-10-09", btcDelta: -2.73,  hedgeFired: false, phValue: 1000.85, plpValue: 1003.85 },
      { week: 2,  date: "2023-10-16", btcDelta: +10.45, hedgeFired: false, phValue: 1001.69, plpValue: 1007.71 },
      { week: 3,  date: "2023-10-23", btcDelta: +15.12, hedgeFired: false, phValue: 1002.54, plpValue: 1011.58 },
      { week: 4,  date: "2023-10-30", btcDelta: +1.41,  hedgeFired: false, phValue: 1003.39, plpValue: 1015.47 },
      { week: 5,  date: "2023-11-06", btcDelta: +5.86,  hedgeFired: false, phValue: 1004.24, plpValue: 1019.38 },
      { week: 6,  date: "2023-11-13", btcDelta: +0.80,  hedgeFired: false, phValue: 1005.09, plpValue: 1023.30 },
      { week: 7,  date: "2023-11-20", btcDelta: +0.23,  hedgeFired: false, phValue: 1005.94, plpValue: 1027.24 },
      { week: 8,  date: "2023-11-27", btcDelta: +6.74,  hedgeFired: false, phValue: 1006.79, plpValue: 1031.19 },
      { week: 9,  date: "2023-12-04", btcDelta: +9.55,  hedgeFired: false, phValue: 1007.64, plpValue: 1035.15 },
      { week: 10, date: "2023-12-11", btcDelta: -5.51,  hedgeFired: true,  phValue: 995.31,  plpValue: 1004.88 },
      { week: 11, date: "2023-12-18", btcDelta: +3.91,  hedgeFired: false, phValue: 996.15,  plpValue: 1008.75 },
      { week: 12, date: "2023-12-25", btcDelta: -1.65,  hedgeFired: false, phValue: 996.99,  plpValue: 1012.63 },
    ],
  },
  {
    id: "E",
    label: "Aug 2024 -- JPY flash crash",
    description: "7-week window around JPY carry unwind. BTC flat on weekly closes. Hedge and PLP essentially tied.",
    finalPH: -6.34,
    finalPLP: -6.33,
    weeks: [
      { week: 1, date: "2024-08-05", btcDelta: +0.95,  hedgeFired: false, phValue: 1000.85, plpValue: 1003.85 },
      { week: 2, date: "2024-08-12", btcDelta: -0.49,  hedgeFired: false, phValue: 1001.69, plpValue: 1007.71 },
      { week: 3, date: "2024-08-19", btcDelta: +9.91,  hedgeFired: false, phValue: 1002.54, plpValue: 1011.58 },
      { week: 4, date: "2024-08-26", btcDelta: -10.77, hedgeFired: true,  phValue: 958.64,  plpValue: 950.09 },
      { week: 5, date: "2024-09-02", btcDelta: -4.24,  hedgeFired: false, phValue: 935.04,  plpValue: 929.55 },
      { week: 6, date: "2024-09-09", btcDelta: +7.77,  hedgeFired: false, phValue: 935.83,  plpValue: 933.13 },
      { week: 7, date: "2024-09-16", btcDelta: +7.52,  hedgeFired: false, phValue: 936.62,  plpValue: 936.71 },
    ],
  },
  {
    id: "F",
    label: "Q1 2025 -- Post-election rally",
    description: "BTC peaked at $102K then pulled back -17% by March. One large trigger, gradual bleed.",
    finalPH: -13.30,
    finalPLP: -12.00,
    weeks: [
      { week: 1,  date: "2025-01-13", btcDelta: +7.18,  hedgeFired: false, phValue: 1000.85, plpValue: 1003.85 },
      { week: 2,  date: "2025-01-20", btcDelta: +1.27,  hedgeFired: false, phValue: 1001.69, plpValue: 1007.71 },
      { week: 3,  date: "2025-01-27", btcDelta: -4.79,  hedgeFired: false, phValue: 973.73,  plpValue: 982.60 },
      { week: 4,  date: "2025-02-03", btcDelta: -1.27,  hedgeFired: false, phValue: 974.55,  plpValue: 986.38 },
      { week: 5,  date: "2025-02-10", btcDelta: -0.36,  hedgeFired: false, phValue: 975.38,  plpValue: 990.17 },
      { week: 6,  date: "2025-02-17", btcDelta: +0.15,  hedgeFired: false, phValue: 976.20,  plpValue: 993.98 },
      { week: 7,  date: "2025-02-24", btcDelta: -2.07,  hedgeFired: false, phValue: 977.03,  plpValue: 997.80 },
      { week: 8,  date: "2025-03-03", btcDelta: -14.36, hedgeFired: true,  phValue: 913.22,  plpValue: 915.68 },
      { week: 9,  date: "2025-03-10", btcDelta: +2.28,  hedgeFired: false, phValue: 914.00,  plpValue: 919.20 },
      { week: 10, date: "2025-03-17", btcDelta: +4.25,  hedgeFired: false, phValue: 914.77,  plpValue: 922.74 },
      { week: 11, date: "2025-03-24", btcDelta: -4.29,  hedgeFired: false, phValue: 892.00,  plpValue: 902.54 },
      { week: 12, date: "2025-03-31", btcDelta: -4.81,  hedgeFired: false, phValue: 867.03,  plpValue: 879.98 },
    ],
  },
];
